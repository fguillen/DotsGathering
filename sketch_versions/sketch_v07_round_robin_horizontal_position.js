...
const NOISE_SCALE = DOTS_RADIUS / 32;
...
function setup() {
  ...
  noiseEllipse = new NoiseGeneratorPointsPosition(2 * NOISE_SCALE, 0.1);
  noiseSize = new NoiseGeneratorPointsPosition(4 * NOISE_SCALE, 0.1 * NOISE_SCALE);
  noisePositionOffset = 2 * NOISE_SCALE;
  noiseDrawingPosition = new NoiseGeneratorPointsPosition(10 * NOISE_SCALE, 0.1 * NOISE_SCALE);
...
class Dot {
  ...
  draw() {
    ...
    Utils.drawNoisedEllipse(noisedPosition, 10, DOTS_RADIUS / 2, DOTS_RADIUS / 2, 0, noiseSeed, _color, blendModeCode, noiseSize, noiseEllipse);
    // fill("purple")
